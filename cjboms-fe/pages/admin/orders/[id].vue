  ...
  <div>
    <div class="container-xl">
      ...
      <div class="page-body position-relative">
        <!-- Loading Overlay for page-body only -->
            ...
            <form @submit.prevent="handleSubmit" v-if="!pageLoading">
              ...
              <div class="mt-4 d-flex justify-content-end gap-2">
                ...
                >
                  ...
                  {{ addedProducts.length === 0 ? 'Please Add Products' : 'Update Order' }}
                </button>
              </div>
            </form>
          </div>
...
const resetForm = () => {
  // Re-fetch the original order data
  fetchOrder()
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const order_items = addedProducts.value.map(product => ({
      id: product.id || undefined, // Include ID only if it exists (for existing items)
